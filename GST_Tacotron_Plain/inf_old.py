...
def synthesis(model_enc,model_gst,model_emb,model_dec, eval_text, emotion,input_text,alpha = 0.7,beta = 0.3,speaker='0012'):
    ...
    speakers = {
      '0012' :  {
        'Angry' : ['/content/drive/MyDrive/GST/ESD/0012/Angry/train/0012_000401.wav'],
        'Sad' : ['/content/drive/MyDrive/GST/ESD/0012/Sad/train/0012_001101.wav'],
        'Surprise' : ['/content/drive/MyDrive/GST/ESD/0012/Surprise/train/0012_001451.wav'],
        'Neutral' : ['/content/drive/MyDrive/GST/ESD/0012/Neutral/train/0012_000051.wav'],
        'Happy' : ['/content/drive/MyDrive/GST/ESD/0012/Happy/train/0012_000751.wav']
      },
      '0015' : {
        'Angry' : ['/content/drive/MyDrive/GST/ESD/0015/Angry/train/0015_000401.wav'],
        'Sad' : ['/content/drive/MyDrive/GST/ESD/0015/Sad/train/0015_001101.wav'],
        'Surprise' : ['/content/drive/MyDrive/GST/ESD/0015/Surprise/train/0015_001451.wav'],
        'Neutral' : ['/content/drive/MyDrive/GST/ESD/0015/Neutral/train/0015_000051.wav'],
        'Happy' : ['/content/drive/MyDrive/GST/ESD/0015/Happy/train/0015_000751.wav']
      }
    }
    ref_wav_dict = {
...
def pred(text,emo,speaker):
    ...
    #   emo = int(input("0: Neutral\n1: Angry\n2: Sad\n3: Happy\n4: Surprise\nChoose emotion by entering the number : "))
        alpha = 0.2#float(input("Enter weight for style vector : "))
        beta = 1.8 #float(input("Enter weight for emotion vector : "))

        emotion = emo_list[1]
        wavs = synthesis(model_enc, model_gst,model_emb,model_dec, text, emotion, text, alpha, beta,speaker)
