...
def train(log_dir, dataset_size, alpha, start_epoch=0):
    ...
    train_loader_amused = torch.load('/content/drive/MyDrive/GST/GST_Tacotron/train_datasets_female/train_loader_amused.pth')
    train_loader_angry =   torch.load('/content/drive/MyDrive/GST/GST_Tacotron/train_datasets_female/train_loader_angry.pth')
    train_loader_disgusted = torch.load('/content/drive/MyDrive/GST/GST_Tacotron/train_datasets_female/train_loader_disgusted.pth')
    train_loader_neutral = torch.load('/content/drive/MyDrive/GST/GST_Tacotron/train_datasets_female/train_loader_neutral.pth')
    train_loader_sleepy = torch.load('/content/drive/MyDrive/GST/GST_Tacotron/train_datasets_female/train_loader_sleepy.pth')
