...
def synthesis(model_enc,model_gst,model_emb,model_dec, eval_text, emotion,input_text,speaker,alpha = 0.7,beta = 0.3):
...
def pred(text,emo,speaker):
    ...
    #   emo = int(input("0: Neutral\n1: Angry\n2: Sad\n3: Happy\n4: Surprise\nChoose emotion by entering the number : "))
        ...
        emotion = emo_list[1]
        wavs = synthesis(model_enc, model_gst,model_emb,model_dec, text, emotion, text, speaker, alpha, beta)
