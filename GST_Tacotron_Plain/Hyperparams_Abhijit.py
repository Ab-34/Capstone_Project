...
class Hyperparameters():
    ...
    # data = '/content/drive/MyDrive/GST/LJSpeech'
    data = '/content/drive/MyDrive/GST_emovDB/emovdb'  
    ...
    # ref_wav = '/content/drive/MyDrive/GST/LJSpeech/wavs/LJ001-0001.wav'
    ref_wav = '/content/drive/MyDrive/GST_emovDB/emovdb/0011/Angry/anger_1-28_0001.wav'
